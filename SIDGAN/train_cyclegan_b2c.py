...
parser.add_argument('--task', default='B2C', type=str, help='path to dataset')
########################### CycleGAN parameters ############################################################
...
parser.add_argument('--lambda_1', default=6.0, type=float, help='Lambda 1')
parser.add_argument('--lambda_2', default=6.0, type=float, help='Lambda 2')
...
parser.add_argument('--use_norm', default=True, type=bool, help='Use normalization layers')
parser.add_argument('--add_extra_conv', default=False, type=bool, help='Add extra convolution layers')
...
parser.add_argument('--save_images_interval', default=2, type=int, help='')
parser.add_argument('--save_models_interval', default=2, type=int, help='')
