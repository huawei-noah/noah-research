...
@register_task("multidds_multilingual_translation")
class MultiddsMultilingualTranslationTask(MultilingualTranslationTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument("--sim-mat-dir", default="", type=str)
    ...
    def __init__(self, args, dicts, training):
        ...
        if not os.path.exists(self.args.sim_mat_dir):
            os.makedirs(self.args.sim_mat_dir)
    ...
    def train_step(
        ...
        if update_num % self.args.update_sampling_interval == 0 and update_num != 0 and data_actor is not None and self.current_sampling_update_num != update_num:
            ...
            np.save(os.path.join(self.args.sim_mat_dir, "sim_mat_%010d.npy" % update_num), sim_mat)
