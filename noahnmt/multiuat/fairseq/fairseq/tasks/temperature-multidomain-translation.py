...
@dataclass
class TemperatureMultidomainTranslationConfig(FairseqDataclass):
...
@register_task("temperature_multidomain_translation", dataclass=TemperatureMultidomainTranslationConfig)
class TemperatureMultidomainTranslation(FairseqTask):
    """
    ...
    cfg: TemperatureMultidomainTranslationConfig

    def __init__(self, cfg: TemperatureMultidomainTranslationConfig, src_dict, tgt_dict):
        super().__init__(cfg)
        self.cfg = cfg
    ...
    @classmethod
    def setup_task(cls, cfg: TemperatureMultidomainTranslationConfig, **kwargs):
