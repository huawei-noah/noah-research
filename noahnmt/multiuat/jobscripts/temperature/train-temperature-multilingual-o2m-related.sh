...
python evaluate-ckpt-multilingual.py --lang-pairs ${LANG_PAIRS} --setup related --ckpt ${SAVE_DIR}/checkpoint_best.pt --split test |& tee ${SAVE_DIR}/train-temperature-multilingual.sh.evaluation.${TEMP}.test.log