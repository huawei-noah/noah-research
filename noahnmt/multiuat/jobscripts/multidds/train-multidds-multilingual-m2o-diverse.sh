...
python evaluate-ckpt-multilingual.py --lang-pairs ${LANG_PAIRS} --setup diverse --ckpt ${SAVE_DIR}/checkpoint_best.pt --split test |& tee ${SAVE_DIR}/train-multidds-multilingual.sh.evaluation.${TEMP}.test.log