...
def main(params):
    ...
    for name in ['n_words', 'bos_index', 'eos_index', 'pad_index', 'unk_index', 'mask_index', 'tgt_n_words']:
        setattr(params, name, getattr(model_params, name))

    # build dictionary / build encoder / build decoder / reload weights
    dico = Dictionary(reloaded['dico_id2word'], reloaded['dico_word2id'], reloaded['dico_counts'])
    tgt_dico = Dictionary(reloaded['tgt_dico_id2word'], reloaded['tgt_dico_word2id'], reloaded['tgt_dico_counts'])
