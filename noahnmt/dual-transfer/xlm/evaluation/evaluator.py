# 2021 - Supported target side dictionary
        ...
        for (lang1, lang2), v in self.data['para'].items():
            ...
            for data_set in ['valid', 'test']:
                ...
                for (sent1, len1), (sent2, len2) in self.get_iterator(data_set, lang1, lang2):
                    if (lang1, lang2) in params.mt_steps:
                        lang1_txt.extend(convert_to_text(sent1, len1, self.dico, params))
                        lang2_txt.extend(convert_to_text(sent2, len2, self.tgt_dico, params))
                    else:
                        lang1_txt.extend(convert_to_text(sent1, len1, self.tgt_dico, params))
    ...
    def evaluate_mt(self, scores, data_set, lang1, lang2, eval_bleu):
        ...
        for batch in self.get_iterator(data_set, lang1, lang2):
            ...
            if eval_bleu:
                ...
                hypothesis.extend(convert_to_text(generated, lengths, self.tgt_dico, params))
