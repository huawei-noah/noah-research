...
def get_parser():
    ...
    parser.add_argument("--reload_model_except_emb", type=str, default="",
                        help="Reload a pretrained model except embeddings")    
    parser.add_argument("--reload_mt_and_enc_emb", type=str, default="",
                        help="For dual transfer. Format: mt_model,bert_model")

    # partial freezing
    parser.add_argument("--freeze_except_emb", type=bool_flag, default=False,
                        help="only embeddings are trainable")
    parser.add_argument("--freeze_encoder_emb", type=bool_flag, default=False,
...
def main(params):
    ...
    if params.encoder_only:
        ...
        encoder, decoder = build_model(params, data['dico'], data['tgt_dico'])
