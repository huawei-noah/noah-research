"""Check NLP assets required by MindMemOS text preprocessing."""
...
def main() -> None:
    ...
    spacy.load(cfg.spacy_en_model)
    spacy.load(cfg.spacy_zh_model)
    list(jieba.cut("中文分词检查", cut_all=cfg.jieba_cut_all))
