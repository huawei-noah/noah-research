...
# ------------------------ Specific Parameters ---------------------- #
acq_funcs=(qCompositionalUpperConfidenceBound qCompositionalExpectedImprovement qCompositionalProbabilityOfImprovement qCompositionalSimpleRegret)
acq_func_kwargs_s=("{'beta':2}" "{}" "{}" "{}")
optimizers=(DEopt-nested CMAESopt-nested)
