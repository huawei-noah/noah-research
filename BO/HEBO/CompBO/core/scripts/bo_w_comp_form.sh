...
# ------------------------ Specific Parameters ---------------------- #
acq_funcs=(qCompositionalExpectedImprovement qCompositionalSimpleRegret qCompositionalUpperConfidenceBound qCompositionalProbabilityOfImprovement)
acq_func_kwargs_s=("{}" "{}" "{'beta':2}" "{}")
optimizers=(NASA-compo CAdam-compo SCGD-compo ASCGD-compo Adam-nested)
