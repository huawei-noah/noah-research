...
def default_cn_invoice_scheduler(
    epochs=50, 
    decay_epochs=40, 
    warmup_epochs=0, 
    iters_per_epoch=90000,
    ):
    """
    ...
    Returns:
        DictConfig: configs that define the multiplier for LR during training
    """
    # total number of iterations assuming 16 batch size, using 1440000/16=90000 12 epcoh
    x = 12 * iters_per_epoch
...
total_samples = 58151
total_batch_size = 32
iters_per_epoch = math.ceil(total_samples / total_batch_size)
...
lr_multiplier_50ep = default_cn_invoice_scheduler(50, 40, 0, iters_per_epoch)
lr_multiplier_36ep = default_cn_invoice_scheduler(36, 33, 0, iters_per_epoch)
lr_multiplier_24ep = default_cn_invoice_scheduler(24, 22, 0, iters_per_epoch)
lr_multiplier_12ep = default_cn_invoice_scheduler(12, 11, 0, iters_per_epoch)

# warmup scheduler for detr
lr_multiplier_50ep_warmup = default_cn_invoice_scheduler(50, 40, 1e-3, iters_per_epoch)
lr_multiplier_12ep_warmup = default_cn_invoice_scheduler(12, 11, 1e-3, iters_per_epoch)
