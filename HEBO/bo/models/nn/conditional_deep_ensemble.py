...
Created:    2020.11.25
Updated:    2020.11.26
Authors:    Chang FENG and Wenlong Lv
Usage:      Conditional deep ensembles
            - Multiple independent components
            - Within each component,
                some parameters are enabled/disabled by some hyperparameter.
TODO:
    - There is only hyper-parameters but no parameters
"""
