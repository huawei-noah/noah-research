...
class Attention(torch.nn.Module):
    def __init__(self, hidden_size, num_attention_heads, attention_probs_dropout_prob, hidden_dropout_prob):
        ...
        self.self = ScaleDotAttention(hidden_size, num_attention_heads, attention_probs_dropout_prob)
        self.output = SelfOutput(hidden_size, hidden_dropout_prob)

    def forward(self, query, key, value, attention_mask, head_mask=None):
        self_output = self.self(query, key, value, attention_mask, head_mask)
