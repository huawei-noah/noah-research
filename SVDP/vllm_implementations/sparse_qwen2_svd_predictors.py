...
class Qwen2MLP(nn.Module):
    ...
    def forward(self, x):
        ...
        if is_prefill:
            ...
            sparse_mlp_qwen2.sparse_gate_proj(self.gate_up_proj.weight.data[:self.intermediate_size], x, sparse_prediction)
...
class SparseQwen2ForCausalLM(nn.Module, SupportsLoRA, SupportsPP):
